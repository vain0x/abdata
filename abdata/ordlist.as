...
// 解体者
//------------------------------------------------
;#deffunc DeleteOrdlist var self
;	Ordlist_delete self
;	return
...
//------------------------------------------------
/*
#define global Ordlist_set(%1,%2,%3) VAR_TEMP@abdata_ordlist = %2 : Ordlist_setv %1, VAR_TEMP@abdata_ordlist, %3
#modfunc Ordlist_setv var vValue, int i,  local iv
	
	iv = midlist( Ordlist_getRealIndex(thismod, i) )
