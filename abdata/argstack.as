...
// プッシュ
//------------------------------------------------
#define global ArgStack_push(%1,%2) v@abdata_argstack = %2 : _ArgStack_pushVar %1,v@abdata_argstack,0
#define global ArgStack_pushVar(%1,%2) _ArgStack_pushVar %1,%2,1
#modfunc _ArgStack_pushVar var variable, int bRef
...
// ポップ
//------------------------------------------------
#modfunc ArgStack_pop var variable
...
// 取得のみ
//------------------------------------------------
#modfunc ArgStack_peek var variable, int p2
...
#define global call(%1,%2=PRM_DUMMY) callcount ++ : ArgStack_init prmof(starg) : argc = 0 : %2: gosub *%1@fcore : delmod prmof_s(starg) : callcount --
...
#define global ctype byRef(%1) ArgStack_pushVar prmof_s(starg), %1 : argc ++ :
callcount = -1
dim prmof(cntargs), 8
...
#defcfunc argv int p1
	...
	ArgStack_peek prmof_s(starg), argval_core, argc - p1 - 1
	return argval_core
	
#define global ctype refarg(%1) prmof(refarg_vcore)(refarg_fcore(%1))
#defcfunc refarg_fcore int p1
	ArgStack_peek prmof_s(starg), prmof(refarg_vcore), argc - p1 - 1
	return 0
